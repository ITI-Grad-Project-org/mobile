...
export const COACH_STEPS: Step[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "yoe", label: "Years of experience", type: "number", placeholder: "8" },
      {
        key: "experience",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "text",
        placeholder: "Mon–Fri · 7 AM – 7 PM",
      },
      { key: "priceMin", label: "Price from", type: "number", placeholder: "120", unit: "$" },
      { key: "priceMax", label: "Price to", type: "number", placeholder: "320", unit: "$" },
    ],
  },
];
